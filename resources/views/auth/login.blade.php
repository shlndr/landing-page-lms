        ...
        <div class="nk-block toggled" id="l-login">
            <div class="nk-form">
                ...
                <div class="fm-checkbox">
                    <label>
                    <input class="form-check-input i-checks" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}><i></i>
                        Keep me signed in
                    </label>
                </div>
            ...
            <div class="nk-navigation nk-lg-ic" style="display: none;">
